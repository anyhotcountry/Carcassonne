...
namespace Carcassonne.Services
{
    public static class FollowerPlacesConfig
    {
        public static IDictionary<string, IList<FollowerPoint>> Positions { get; } = new Dictionary<string, IList<FollowerPoint>>
        {
            ...
            ["03crrf00"] = new[] { new FollowerPoint(0, 0, EdgeTypes.Field), new FollowerPoint(0, 0.84, EdgeTypes.City), new FollowerPoint(0.28, -0.2, EdgeTypes.Road), new FollowerPoint(0.56, -0.56, EdgeTypes.Field), },
            ...
            ["08rfrf00"] = new[] { new FollowerPoint(0, 0, EdgeTypes.Road), new FollowerPoint(0.56, 0, EdgeTypes.Field), new FollowerPoint(-0.6, 0, EdgeTypes.Field), },
